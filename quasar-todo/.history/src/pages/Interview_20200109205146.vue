...
export default {
  data() {
    return{
      ...
      model11: null,
      options1: [
        'bakłażan', 'brokuł', 'buraki', 'czosnek', 'cebula', 'cukinia', 'rzodkiewka', 'fasola szparagowa', 'fasola ziarnista', 'groszek', 'groszek z marchewką', 'marchew', 'ogórek', 'ogórek kiszony', 'oliwki', 'papryka', 'kapusta pekińska', 'pomidor', 'por', 'sałata', 'seler korzeń/nać', 'soczewica/ciecierzyca', 'kiszona kapusta', 'suszone pomidory', 'Oracle', 'penis', 'benis', 'Twitter', 'Apple', 'Oracle', 
      ],
      options2: [
