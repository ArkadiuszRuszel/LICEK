...
export default {
  data() {
    return{
      ...
      options2: [
        'awokado', 'banan', 'granat', 'porzeczki', 'ananas', 'gruszka', 'jabłko', 'jagody/borówki', 'kiwi', 'mango', 'maliny', 'grapefruit', 'mandarynka', 'melon', 'morela', 'pomarańcz', 'suszona morela', 'suszona śliwa', 'suszona żurawina', 'śliwka','', 'benis', 'Twitter', 'Apple', 'Oracle', 
      ],
      options3: [
