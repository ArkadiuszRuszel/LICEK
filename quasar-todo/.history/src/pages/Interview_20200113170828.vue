<template>
  <q-page class="q-pa-lg bg-grey-1">
    ...
    <div class="row">
           <q-input 
           class="col bg-green-6" 
           v-model="newProduct" 
           label="Dodaj inny produkt, który LUBISZ i którego nie ma poniżej" 
           color="white"
           text-bold
           filled
           square
        ...
        <template v-slot:append>
          <q-btn round dense flat icon="add" @click="addProduct"/>
            ...
            class="col bg-red-6"
            v-model="newProduct" 
            label="Dodaj inny produkt, którego NIE LUBISZ i którego nie ma poniżej" 
            color="white"
            filled    
            square
            @keyup.enter="addProduct"
    ...
    <q-list class="bg-white" separator>
      ...
      :class="{'done bg-green-1': product.done}">
          ...
          <q-input v-model="product.done" filledcolor="green" class="no-pointer-events"/>
        <q-item-section>
