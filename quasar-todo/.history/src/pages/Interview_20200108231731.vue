<template>
  <q-page class="q-pa-lg">
      <h5>Witaj, tutaj możesz wybraź produkty, które spożywasz.</h5>
      <p>Możesz także zaznaczyć produkty, których NIE jadasz i je usunąć.</p>
    ...
    <q-list class="bg-white" separator bordered>
      ...
      >
        ...
        <q-item-section v-if="product.done" side>
          <q-btn flat round color="green" icon="delete" @click.stop="deleteProduct(index)"/>
        </q-item-section>
      </q-item>
    </q-list>
  </q-page>
