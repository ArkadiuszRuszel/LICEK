<template>
  <q-page class="bg-white-3 class="q-pa-lg"">
      <h5>Witaj, tutaj możesz wybraź produkty, które spożywasz.</h5>
      <h6>Możesz także zaznaczyć produkty, których NIE jadasz i je usunąć.</h6>
    ...
    <q-list class="bg-white" separator bordered>
      ...
      >
        <q-item-section avatar>
          <q-checkbox v-model="product.done" color="psecondary" class="no-pointer-events"/>
        </q-item-section>
        <q-item-section>
