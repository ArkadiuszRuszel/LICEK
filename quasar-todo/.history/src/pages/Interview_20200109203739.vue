    ...
    <p></p>
        ...
        <template v-slot:prepend>
          <q-icon name="img:statics/icons/soup.png"/>
                  ...
                  <q-select transition-show="flip-up" transition-hide="flip-down" multiple color="grey" bg-color="orange-3" filled v-model="model10" :options="options10" label="Dodatki">
        <template v-slot:prepend>
          <q-icon name="img:statics/icons/soup.png"/>
       </template> 
      </q-select>
