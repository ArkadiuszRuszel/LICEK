    ...
    <p></p>
        ...
        <template v-slot:prepend>
          <q-icon name="img:statics/icons/cereal.png"/>
            ...
            <q-select transition-show="flip-up" text-decoration: line-throughtransition-hide="flip-down" multiple color="red" bg-color="orange-3" filled v-model="model9" :options="options9" label="Zupy">
        <template v-slot:prepend>
