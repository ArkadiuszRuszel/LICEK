<template>
  <q-page class="q-pa-lg bg-grey-1">
    ...
    <div class="row bg-green">
      ...
      <q-select transition-show="flip-up" transition-hide="flip-down" multiple color="black" bg-color="green-3" filled v-model="model1" :options="options1" label="Owoce i warzywa">
...
export default {
  data() {
    return{
      ...
      single: null,
      options1: [
        'penis', 'Facebook', 'Twitter', 'Apple', 'Oracle'
      ],
      options2: [
