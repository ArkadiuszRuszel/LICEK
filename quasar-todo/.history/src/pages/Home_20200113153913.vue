...
<br>
<br>
      <div id="login" class="ellipsis bg-transparent position-center">

        <p class="text-h5 text-bold position-center">Zaloguj się poniżej do swojego konta.</p>
...
<br>
        <q-btn :loading="loading5" color="green-5" @click="simulateProgress(5)" v-on:click="login()" icon="arrow_forward"> Zaloguj się
          <template v-slot:loading>
            <q-spinner-facebook class="on-right"/>
          </template>
        </q-btn>
        <q-btn :loading="loading5" color="blue-5" @click="simulateProgress(5)" v-on:click="passrem()" icon="live_help" >Nie pamiętam hasła
      <template v-slot:loading>
