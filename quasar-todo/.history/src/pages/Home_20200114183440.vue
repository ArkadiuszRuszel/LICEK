...
<br>
        ...
        <q-btn rounded no-caps :loading="loading6" color="blue-5" @click="simulateProgress(6)" v-on:click="passrem()" width="200px">Nie pamiętam hasła<br>
          </q-popup-proxy><q-popup-proxy transition-show="flip-up" transition-hide="flip-down">
        <q-banner> Sprawdź skrzynkę pocztową
      <template v-slot:loading>
          <q-spinner-facebook class="on-right"/>
      </template>
              </q-banner>
