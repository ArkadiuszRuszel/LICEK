...
<br>
    <div id="login" class="q-gutter-xs bg-transparent text-center">
...
<br>
    ...
    <p class="text-body2 text-bold"> Nie masz jeszcze konta? Załóż je! </p>
      <a href="/#/NewAccount"><q-btn rounded no-caps color="blue-12" icon="group_add" class="konto"> Stwórz konto
          <template v-slot:loading>
            <q-spinner-facebook class="on-right"/>
          </template>
        </q-btn>
