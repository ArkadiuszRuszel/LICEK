...
<br>
        <q-btn round :loading="loading5" color="brown" @click="simulateProgress(5) v-on:click="login()" icon="camera_front">
      <template v-slot:loading><button type="button-2" v-on:click="login()">Zaloguj</button>
