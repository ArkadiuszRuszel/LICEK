...
<br>
        <q-btn rounded no-caps :loading="loading5" color="green-8" @click="simulateProgress(5)" v-on:click="login()" icon-right="arrow_forward">Zaloguj
...
<br>
    ...
    <p class="text-body2 text-bold">Nie masz jeszcze konta? Załóż je!</p>
      <q-btn rounded no-caps color="green" icon="group_add">Stwórz konto
          <template v-slot:loading>Stwórz konto
            <q-spinner-facebook class="on-right"/>Stwórz konto
          </template>
        </q-btn>
        </div>
     <br>
     <q-img class="bottom text-center" src="statics/you.png" style="height: auto"></q-img>
</q-page> 
</template>
