<template>
  <q-page class="q-pa-lg bg-grey-1">
    ...
    <div class="row bg-green">
      ...
      <q-select transition-show="flip-up" transition-hide="flip-down" multiple color="black" bg-color="green-3" filled v-model="model" :options="options" label="Owoce i warzywa">
        <template>
