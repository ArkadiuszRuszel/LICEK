...
<br>
        <q-btn :loading="loading5" color="green" @click="simulateProgress(5)" v-on:click="login()" icon="arrow-forward float-right"> Zaloguj się
          <template v-slot:loading>
            <q-spinner-facebook class="on-right"/>
          </template>
        </q-btn>
        <q-btn :loading="loading5" color="green" @click="simulateProgress(5)" v-on:click="login()" icon="arrow-forward"> Zaloguj się
      <template v-slot:loading>
                <q-spinner-facebook class="on-right"/>
      </template>
      </q-btn>
