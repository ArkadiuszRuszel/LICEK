...
export default {
  data() {
    return{
      ...
      model11: null,
      options1: [
        'bakłażan', 'brokuł', 'buraki', 'czosnek', 'cebula', 'cukinia', 'rzodkiewka', 'fasola szparagowa', 'fasola ziarnista', 'groszek', 'groszek z marchewką', 'marchew', 'ogórek', 'ogórek kiszony', 'oliwki', 'papryka', 'benis', 'Twitter', 'Apple', 'Oracle'
      ],
      options2: [
