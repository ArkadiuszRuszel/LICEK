<template>
  ...
  <q-img class="h3-image bg-transparent" src="statics/you.png" >  
...
<br>
<br>
      <div id="login" class="ellipsis bg-transparent absolute-mid">

        <p class="text-h5 text-bold absolute-mid">Zaloguj się poniżej do swojego konta.</p>
...
<br>
        <q-btn rounded no-caps :loading="loading5" color="green-5" @click="simulateProgress(5)" v-on:click="login()" icon-right="arrow_forward">Zaloguj się
        ...
        <br><q-btn rounded no-caps :loading="loading6" color="blue-5" @click="simulateProgress(6)" v-on:click="passrem()" width="200px">Nie pamiętam hasła
      <template v-slot:loading>
