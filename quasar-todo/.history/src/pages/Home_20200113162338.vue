...
<br>
<br>
      <div id="login" class="ellipsis bg-transparent margin-auto">
...
<br>
        <q-btn rounded no-caps :loading="loading5" color="green-9" @click="simulateProgress(5)" v-on:click="login()" icon-right="arrow_forward">Zaloguj się
