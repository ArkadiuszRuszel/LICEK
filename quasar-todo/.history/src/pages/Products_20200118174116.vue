...
<script>
const columns = [
  { name: 'desc', style: 'width: 150px', align: 'left', label: 'Rodzaj produktu (100 g)', field: 'name' },
  { name: 'comment', style: 'width: 200px', align: 'left', label: 'Opis produktu', field: 'comment' },
  { name: 'calories', align: 'center', label: 'Kalorie (w 100g/100ml)', field: 'calories', sortable: true },
  { name: 'carbohydrates', align: 'center', label: 'Węglowodany (w 100g)', field: 'carbohydrates', sortable: true },
  { name: 'roughage', align: 'center', label: 'Błonnik (w 100g)', field: 'roughage', sortable: true },
