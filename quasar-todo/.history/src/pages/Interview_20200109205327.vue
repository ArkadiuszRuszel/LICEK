...
export default {
  data() {
    return{
      ...
      options2: [
        'awokado', 'banan', 'granat', 'porzeczki', 'ananas', 'gruszka', 'jabłko', 'jagody/borówki', 'kiwi', 'mango', 'maliny', 'grapefruit', 'mandarynki', 'Apple', 'Oracle', 'penis', 'benis', 'Twitter', 'Apple', 'Oracle'
      ],
      options3: [
