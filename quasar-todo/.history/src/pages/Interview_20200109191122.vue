<template>
  <q-page class="q-pa-lg bg-grey-1">
      <p class="text-h5 text-bold bg-grey-1">W tym miejscu możesz wybrać produkty, które spożywasz w celu wypełnienia wywiadu żywieniowego dla dietetyka.</p>
      <p class="text-subtitle1 bg-grey-1">Możesz także wykreślić produkty, których NIE jadasz.</p>
    ...
    <q-list class="bg-white" separator>
      ...
      >
        <q-item-section avatar>
          <q-checkbox v-model="product.done" color="green" class="no-pointer-events"/>
        </q-item-section>
        <q-item-section>
    ...
    return{
      ...
      products: [
      {
        ...
        title: "rzodkiewka",
             ...
             {
        title: "fasola szparagowa",
        done: false
      },
             {
        title: "fasola ziarnista",
        done: false
      },
             {
        title: "groszek",
        ...
        title: "sałata",
             ...
             {
        title: "seler korzeń/nać",
        done: false
      },
             {
        title: "soczewica/ciecierzyca",
        done: false
      },
             {
