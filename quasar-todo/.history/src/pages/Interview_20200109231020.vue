<template>
  <q-page class="q-pa-lg bg-grey-1">
    ...
    <p></p>
            <q-select class="istransition-show="flip-up" transition-hide="flip-down" multiple color="red" bg-color="green-3" filled v-model="model1" :options="options1" label="Warzywa">
