      ...
      <template v-slot:body="props">
        <q-tr :props="props">
          ...
          <q-td key="date" :props="props">
            ...
            <q-input filled v-model="date" mask="date" :rules="['date']"  v-model.number="props.row.date" dense autofocus>
            <q-popup-proxy ref="qDateProxy" transition-show="scale" transition-hide="scale"/>
            <q-date v-model="date" @input="() => $refs.qDateProxy.hide()" v-model.number="props.row.date" dense autofocus/>
            </q-popup-edit>
          </q-td>
