...
<br>
        ...
        <q-btn @click="icon = true" rounded no-caps :loading="loading6" color="blue-5" @click="simulateProgress(6)":";icon="true"" v-on:click="passrem()" width="200px">Nie pamiętam hasła
          <q-popup-proxy transition-show="flip-up" >
            <q-banner class="text-green"> Sprawdź skrzynkę pocztową
              <template v-slot:loading>
                <q-spinner-facebook class="on-right"/>
              </template>
            </q-banner>
