...
<br>
        <q-btn rounded no-caps :loading="loading5" color="green-8" @click="simulateProgress(5)" v-on:click="login()" icon-right="arrow_forward" class="col">Zaloguj
          <template v-slot:loading>
            <q-spinner-facebook class="on-right"/>
          </template>
        </q-btn>
        <q-btn rounded no-caps :loading="loading6" color="blue-5" @click="simulateProgress(6)" v-on:click="passrem()" width="200px"class="col">Nie pamiętam hasła
      <template v-slot:loading>
