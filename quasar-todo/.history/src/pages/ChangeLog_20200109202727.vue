  ...
  <p class="text-h5 text-bold">Zapisuj swoje postępy w dzienniku - motywuj się!</p>
   ...
   <q-table
      ...
      <template v-slot:body="props" append>
        ...
        <q-btn flat dense color="green" :disable="loading" label="Dodaj dzień" @click="addRow" />


      </template>
    </q-table>
    <q-btn unelevate color="green" :disable="loading" label="Dodaj dzień" @click="addRow" />
        <q-btn unelevate color="green" :disable="loading" label="Dodaj dzień" @click="deleteRow" />
  </div>
</template>
