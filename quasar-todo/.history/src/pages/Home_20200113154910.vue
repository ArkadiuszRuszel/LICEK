...
<br>
        ...
        <q-btn no-caps :loading="loading6" color="blue-5" @click="simulateProgress(6)" v-on:click="passrem()" icon-right="arrow_backward">Nie pamiętam hasłaicon-right="arrow_backward"
      <template v-slot:loading>
