      ...
      <q-select transition-show="flip-up" transition-hide="flip-down" multiple color="black" bg-color="yellow-3" filled v-model="model2" :options="options2" label="Owoce">
        <template v-slot:prepend>
          <q-icon name="img:statics/bread.png"/>
            ...
            <q-select transition-show="flip-up" transition-hide="flip-down" multiple color="black" bg-color="yellow-3" filled v-model="model2" :options="options2" label="Nabiał">
        <template v-slot:prepend>
          <q-icon name="img:statics/bread.png"/>
       </template> 
      </q-select>

            <q-select transition-show="flip-up" transition-hide="flip-down" multiple color="black" bg-color="yellow-3" filled v-model="model2" :options="options2" label="Pieczywo">
        <template v-slot:prepend>
          <q-icon name="img:statics/bread.png"/>
       </template> 
      </q-select>
