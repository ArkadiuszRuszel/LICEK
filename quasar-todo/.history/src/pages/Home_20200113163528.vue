...
<br>
<br>
      <p class="text-h5 text-bold login">Zaloguj się poniżej do swojego konta</p>
        <input type="text" name="mail" v-model="input.username" placeholder="Twój email" position="absolute"/>
