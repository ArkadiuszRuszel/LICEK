...
<br>
      ...
      <a href="/#/NewAccount"><q-btn rounded no-caps :loading="loading6" color="blue-5" @click="simulateProgress(6)"  width="200px">Nie pamiętam hasła
          <template v-slot:loading>
            <q-spinner-facebook class="on-right"/>
          </template>
        </q-btn>
...
<br>
    ...
    <p class="text-body2 text-bold"> Nie masz jeszcze konta? Załóż je! </p>
      <a href="/#/ForgotPassword"><q-btn rounded no-caps color="green" icon="group_add" class="konto"> Stwórz konto
          <template v-slot:loading>
            <q-spinner-facebook class="on-right"/>
          </template>
        </q-btn>
