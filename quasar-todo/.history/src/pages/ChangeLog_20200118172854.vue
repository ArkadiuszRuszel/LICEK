<template>
  <q-page class="q-gutter-xs q-pa-md bg-grey-1">
  ...
  <p class="text-h5 text-bold">Zapisuj swoje postępy w dzienniku - motywuj się!</p>
   ...
   <q-table
    ...
    <br>
    <q-btn no-caps rounded color="green" :disable="loading" label="Dodaj dzień" @click="addRow" />
    <q-btn no-caps rounded color="red" :disable="loading" label="Usuń dzień" @click="deleteRow" />
