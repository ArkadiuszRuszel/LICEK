...
<br>
      ...
      <q-btn  rounded no-caps :loading="loading6" color="blue-5" @click="simulateProgress(6)"  width="200px">Nie pamiętam hasła
        <q-dialog v-model="icon">
          <q-card>
            <q-card-section class="row items-center q-pb-none">
              <div class="text-h6 text-bold text-red text-center">Uwaga!</div>
              <q-space />
