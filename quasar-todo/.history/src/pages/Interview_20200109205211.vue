...
export default {
  data() {
    return{
      ...
      model11: null,
      options1: [
        'bakłażan', 'brokuł', 'buraki', 'czosnek', 'cebula', 'cukinia', 'rzodkiewka', 'fasola szparagowa', 'fasola ziarnista', 'groszek', 'groszek z marchewką', 'marchew', 'ogórek', 'ogórek kiszony', 'oliwki', 'papryka', 'kapusta pekińska', 'pomidor', 'por', 'sałata', 'seler korzeń/nać', 'soczewica/ciecierzyca', 'kiszona kapusta', 'suszone pomidory', 'bób', 'szpinak', 'kukurydza', 'soki warzywne', 'dynia', 'Oracle', 
      ],
      options2: [
        'gdfg', 'Fadfgd', 'Tdfgdg', 'Adfgde', 'Ordfgdfcle', 'penis', 'benis', 'Twitter', 'Apple', 'Oracle', 'penis', 'benis', 'Twitter', 'Apple', 'Oracle', 'penis', 'benis', 'Twitter', 'Apple', 'Oracle'
      ],
      options3: [
