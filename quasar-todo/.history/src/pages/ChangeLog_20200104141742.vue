...
const columns = [
  ...
  { name: 'sodium', label: '%TK - Procent Tkanki Tłuszczowej', field: 'sodium' },
  { name: 'calcium', label: 'MM - Masa Mięśni (kg)', field: 'calcium' },
  { name: 'iron', label: 'Obwód pasa (cm)', field: 'iron' },
  { name: 'iron', label: 'Wskaźnik BMI', field: 'iron' },
]
