...
<br>
<p class="text-bold">Utwórz nowe konto poniżej:</p>
    <q-avatar> Dodaj swój avatar :)
      <img src="">
    </q-avatar>
...
<br>
    ...
    <a href="/#/Account"><q-btn rounded :loading="loading4" color="green" @click="simulateProgress(4)" style="width: 220px"> Utwórz konto
