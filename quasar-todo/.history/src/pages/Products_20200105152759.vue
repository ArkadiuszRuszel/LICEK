<template>
  <div class="q-pa-md">
              <q-input borderless dense debounce="300" v-model="filter" placeholder="Znajdź produkt" corner="top-right" >
            <q-icon name="search" />
          </q-input>
   <q-table
    :data="data"
    :columns="columns"
    title="Informacje o produktach",           <q-input borderless dense debounce="300" v-model="filter" placeholder="Znajdź produkt" corner="top-right" >
            <q-icon name="search" />
          </q-input>
    row-key="name"
...
<script>
const columns = [
  { name: 'desc', style: 'min-width: 160px; width: 160px', align: 'left', label: 'Rodzaj produktu (100g)', field: 'name' },
  { name: 'comment', style: 'min-width: 200px; width: 200px', align: 'left', label: 'Opis produktu', field: 'comment' },
