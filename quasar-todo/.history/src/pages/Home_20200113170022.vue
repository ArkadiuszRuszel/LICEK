...
<h5 class="q-md-none text-center text-bold" >Witaj na stronie Twojego zdrowszego życia!</h5>
<h6 class="q-md-none text-center text-body1">Na danej stronie możesz prowadzić swój dziennik postępów w ramach stosowania diety, 
  ...
  zaczerpnąć wiedzy o produktach.
      ...
      <div id="login" class="bg-transparent text-center">
        <p class="text-h6 text-bold">Zaloguj się poniżej do swojego konta.</p>
