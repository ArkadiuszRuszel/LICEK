  ...
  <q-page class="q-pa-lg bg-grey-1">
    ...
    <div class="row bg-green">
      ...
      <q-select transition-show="flip-up" transition-hide="flip-down" multiple color="black" bg-color="green-3" filled v-model="model" :options="options1" label="Owoce i warzywa">
        ...
        <q-select transition-show="flip-up" transition-hide="flip-down" multiple color="black" bg-color="yellow-3" filled v-model="model" :options="options" label="Owoce i warzywa">
        <q-icon name="img:statics/fruitsvegetables.png"/>
      </q-select>
