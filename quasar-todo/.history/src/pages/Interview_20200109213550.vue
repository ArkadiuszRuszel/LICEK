    ...
    <p></p>
        ...
        <template v-slot:prepend>
          <q-icon name="img:statics/icons/groats.png"/>
            ...
            <q-select transition-show="flip-up" transition-hide="flip-down" multiple color="red" bg-color="cyan-3" filled v-model="model10" :options="options10" label="Inne">
        <template v-slot:prepend>
...
<div>
<br>
         <q-btn :loading="loading4" color="green" @click="simulateProgress(4)" style="width: 200px">
            Zapisz zmiany
...
export default {
  ...
  methods: {
    ...
    simulateProgress(number) {
      this[`loading4${number}`] = true
      setTimeout(() => {
        this[`loading4${number}`] = false
      }, 500)
    }
}
</script>
