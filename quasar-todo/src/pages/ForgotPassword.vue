          ...
          <div class="card-body text-center">
            <form autocomplete="off" @submit.prevent="requestResetPassword" method="post">
              <div class="form-group">
                  <p class="text-body1 text-center">Nie przejmuj się, nic straconego! <br>Wpisz poniżej swojego emaila, a my wyślemy na niego link potrzebny do zresetowania hasła.</p>
                  <input type="email" id="email" class="kontrolka text-center" placeholder="twój@email.com" color="green" v-model="email" required>
              </div>
              <br>
              <q-btn type="submit" rounded color="blue-5" class="zapomnianekonto">Wyślij email</q-btn>
            </form>
          </div>
  </q-page>
</template>
